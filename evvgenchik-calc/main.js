...
import { deletion } from "./deleteModule.js"
const equal = document.querySelector('.equals')
const calcResult = document.querySelector('.final-results')
...
function calc() {
	...
	result.innerHTML = storageForResults
}
...
calcResult.addEventListener('click', deletion)
